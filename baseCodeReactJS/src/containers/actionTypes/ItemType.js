...
export const DROPDOWN_ITEMS_REQUEST = 'DROPDOWN_ITEMS_REQUEST'
export const DROPDOWN_ITEMS_SUCCESS = 'DROPDOWN_ITEMS_SUCCESS'
export const DROPDOWN_ITEMS_FAILURE = 'DROPDOWN_ITEMS_FAILURE'

export const SEARCH_ITEMS_2_REQUEST = 'SEARCH_ITEMS_2_REQUEST'
export const SEARCH_ITEMS_2_SUCCESS = 'SEARCH_ITEMS_2_SUCCESS'
export const SEARCH_ITEMS_2_FAILURE = 'SEARCH_ITEMS_2_FAILURE'
